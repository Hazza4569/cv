...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}[t]{0.7\textwidth}
    ...
    {\fontfamily{phv}\fontseries{sluc}\fontsize{12}{14}\selectfont\color{hl}%
      ...
      Particle Physicist\sep Software Engineer
    }
...
\begin{minipage}[t]{0.64\textwidth}
  ...
  {\info%
    Designing and installing upgrades to the ATLAS trigger
  }\\
  {\info%
    Using statistical analysis, machine learning, programming in \cpp and Python
  }\\
  {\itinfo%
    *pending approval of corrections
  }\\[\intersegmentspacing]
  ...
  {\desc%
    Built monitoring and visualisation GUI tools for use with detector hardware.
    Small personal web projects. 6 years of experience.
  }\\
