...
\begin{minipage}[t]{0.64\textwidth}
  ...
  %Working on physics analyses for the ATLAS collaboration}\\
  ...
  \\[\intersegmentspacing]
   %{\grade Average grade 84\%},
   %{\info received award for {highest overall grade in the year} for third year of studies}\\
